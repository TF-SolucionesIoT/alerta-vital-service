...
public class SignInResultToResponseAssembler {
    public static AuthResponseResource fromResultToResponse(AuthResponseResult authResponseResult) {
        return new AuthResponseResource(authResponseResult.accessToken(), authResponseResult.refreshToken(), authResponseResult.userId(), authResponseResult.typeOfUser(), authResponseResult.fullName());
    }
}
