...
public record SignUpPatientCommand(String firstName, String lastName, String email, String gender, String username, String password, LocalDate birthday) {
    public SignUpPatientCommand {
